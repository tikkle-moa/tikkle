...
export interface PaymentCheckoutFixture {
...
export const createPaymentCheckoutFixture = (): PaymentCheckoutFixture => ({
  reservationId: PAYMENT_FIXTURE_RESERVATION_ID,
  holdId: "fixture-hold-501",
  orderId: `tikkle-fixture-${PAYMENT_FIXTURE_RESERVATION_ID}`,
